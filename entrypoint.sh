...
# um schema ainda inexistente (PGOPTIONS=-c search_path=notification,public).
...
with connection.cursor() as cursor:
    cursor.execute("CREATE SCHEMA IF NOT EXISTS notification")
print("    schema 'notification' pronto.")
PY
